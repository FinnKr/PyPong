...
def init():
    ...
    screen = pygame.display.set_mode((screenWidth, screenHeight))  # Surface on screen with size of screenWidth x screenHeight
    settings(screen)
            ...
            if event.type == pygame.KEYDOWN and event.key == pygame.K_RIGHT:
                ...
                if(settingsIterator == 0):
                    ...
                    if(playerNumber == 1):
                        ...
                        playerNumber = 1
                    renderAndUpdate(screen, str(playerNumber), ownWhite, ownBlack, (screenWidth//2, 20 + 20*settingsIterator + settingsText.get_height()))
                elif(settingsIterator == 2):
                    playerSpeed += 1
                    renderAndUpdate(screen, str(playerSpeed), ownWhite, ownBlack, (screenWidth//2, 20 + 20*settingsIterator + settingsText.get_height()))
